                            ...
                            <div class="main-menu__call-search">
                                <div class="main-menu__call">
                                    ...
                                    <div class="main-menu__call-content">
                                        ...
                                        <p><a href="tel:08800115244">+27 61 337 0359</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card">
                            <img class="img-fluid rounded mb-3" src="assets/pic1.jpeg" alt="Field operations">
                            <h3 class="service-card__title">Mine-to-Port Program</h3>
                            <span class="service-card__subtitle">On-site Asset Coordination</span>
                            <p>Heavy machinery, including dump trucks and excavators, are positioned centrally at the operational site, ready for deployment in our integrated logistics programs.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card">
                            <img class="img-fluid rounded mb-3" src="assets/pic2.jpeg" alt="Logistics field">
                            <h3 class="service-card__title">Integrated Logistics Hub</h3>
                            <span class="service-card__subtitle">Large-Scale Earthworks</span>
                            <p>Our projects often involve extensive excavation, creating terraced landscapes of earth and rock, managed with precision to ensure operational efficiency and safety.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="service-card">
                            <img class="img-fluid rounded mb-3" src="assets/pic3.jpeg" alt="Sustainable field work">
